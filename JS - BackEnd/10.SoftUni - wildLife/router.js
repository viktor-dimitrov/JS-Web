...
router.get('/vote/:_id/:_vote',isAuth, itemController.postVote);


router.get('/myPosts',isAuth, itemController.getMyPostsPage);

// router.get('/search', itemController.getSearchPage);
// router.post('/search', itemController.postSearch);
